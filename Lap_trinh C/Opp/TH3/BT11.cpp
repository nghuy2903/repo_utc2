...
int main()
{
    ...
    MyArray<int> a(10,"a"); //mảng a có kích thước 10, chứa 3 giá trị, push thêm 5 số nữa
    a.InputArray(3);
    cout<<a;
    ...
    MyArray<int> c(10,"c"); //mảng c có kích thước 10, chứa 7 giá trị, push thêm 5 số nữa
    c.InputArray(7);
    cout<<c;
