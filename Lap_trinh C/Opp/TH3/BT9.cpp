...
int main()
{
    ...
    MyArray<long> d("d"); //chưa biết kích thước mảng
    d.InputArray(3);/* có quan tâm đến số lượng, hỏi user có muốn thiết lập kích thước mảng là 3 luôn không, có 2 tình huống xảy ra:
                        TH1: user trả lời Có, thiết lập kích thước là 3 và tiếp tục nhập 3 giá trị
                        TH2: user trả lời Không, yêu cầu nhập kích thước mảng. Lại có ngoại lệ sau:
                            2.1. Nếu kích thước vừa nhập < 3 thì yêu cầu nhập lại cho đến khi hợp lệ
                            2.2. Ngược lại, thiết lập kích thước và tiếp tục nhập 3 giá trị
                    */
    cout<<d;
    cout << "\nSo luong phan tu cua mang d: " << d.GetSize();
    cout << "\nKich thuoc cua mang d: " << d.GetLength();
